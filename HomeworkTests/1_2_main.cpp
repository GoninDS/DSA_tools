...
int main() {
  constexpr int TAMANNO_ARREGLO = 1000;
  ...
  probarOrdenamiento(ordenador, arreglo, &Ordenador::ordenamientoPorMonticulos,
                     "ORDENAMIENTO POR MONTICULOS");
  probarOrdenamiento(ordenador, arreglo, &Ordenador::ordenamientoRapido,
                     "ORDENAMIENTO POR RAPIDO");
  probarOrdenamiento(ordenador, arreglo, &Ordenador::ordenamientoPorRadix,
  ...
  probarProgramacionDefensiva(ordenador, &Ordenador::ordenamientoPorMezcla,
                              "ORDENAMIENTO POR MEZCLA");
  probarProgramacionDefensiva(ordenador, &Ordenador::ordenamientoRapido,
                              "ORDENAMIENTO POR RAPIDO");
  probarProgramacionDefensiva(ordenador, &Ordenador::ordenamientoPorRadix,
                              "ORDENAMIENTO POR RADIX");
